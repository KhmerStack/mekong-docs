...
**New in v1.5.0:**
- One-liner installers: `curl -fsSL https://angkorsearch.dev/install.sh | sh` (macOS/Linux) and `irm https://angkorsearch.dev/install.ps1 | iex` (Windows)
...
curl -fsSL https://angkorsearch.dev/install.sh | sh

# Windows PowerShell
irm https://angkorsearch.dev/install.ps1 | iex
```
...
- [Deployments](/docs/deployments) — upload a zip and host it on Mekong
