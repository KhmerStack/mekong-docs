...
mekong login
mekong 3000                                      # → https://myapp.proxy.angkorsearch.dev
...
onlyanime                https://onlyanime.proxy.angkorsearch.dev         :3001     Up 5h        5 hours ago        18h left
topupml                  https://topupml.proxy.angkorsearch.dev           :3000     Up 2h        2 hours ago        6d left
```
...
```
  ...
  https://angkorsearch.dev/cli-auth?session=xxxxxxxx
...
```
  ...
  Active tunnels
  ─────────────────────────────────────────────────────
  URL        https://onlyanime.proxy.angkorsearch.dev
