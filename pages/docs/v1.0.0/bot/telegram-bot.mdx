...
<div className="not-prose relative overflow-hidden rounded-[28px] border border-sky-200 bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.18),_transparent_42%),linear-gradient(135deg,_#f0f9ff_0%,_#ecfeff_50%,_#ffffff_100%)] p-6 shadow-sm dark:border-sky-900 dark:bg-[radial-gradient(circle_at_top_left,_rgba(56,189,248,0.16),_transparent_40%),linear-gradient(135deg,_rgba(12,74,110,0.55)_0%,_rgba(8,47,73,0.7)_45%,_rgba(2,6,23,0.95)_100%)]">
    ...
    <div className="flex items-start justify-between gap-4">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="m-0 text-3xl font-semibold tracking-tight text-slate-900 dark:text-slate-50">Telegram Bot</p>
