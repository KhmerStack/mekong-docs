...
<div className="not-prose my-5 rounded-2xl border border-sky-200 bg-sky-50 p-4 dark:border-sky-900 dark:bg-sky-950/30">
  <p className="m-0 text-xs font-semibold uppercase tracking-[0.2em] text-sky-700 dark:text-sky-300">Direct Link</p>
  <a
    href="https://t.me/MekongTunnelBot"
    target="_blank"
    rel="noreferrer"
    className="mt-3 inline-flex items-center gap-2 rounded-xl bg-sky-500 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-sky-600"
  >
    <FaTelegramPlane className="h-4 w-4" />
    Open @MekongTunnelBot
  </a>
  <p className="mt-3 mb-0 text-sm text-slate-600 dark:text-slate-300">
    Or open <a href="https://t.me/MekongTunnelBot" target="_blank" rel="noreferrer" className="font-semibold text-sky-700 underline decoration-sky-300 underline-offset-4 dark:text-sky-300">t.me/MekongTunnelBot</a> directly.
  </p>
</div>

1. Open Telegram.
2. Search for `@MekongTunnelBot`, open [t.me/MekongTunnelBot](https://t.me/MekongTunnelBot), or open your deployed Mekong bot username.
